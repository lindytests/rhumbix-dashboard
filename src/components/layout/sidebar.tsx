...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 flex h-screen w-60 flex-col bg-sidebar border-r border-sidebar-border transition-transform duration-200",
          "lg:translate-x-0",
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                onClick={() => setMobileOpen(false)}
                className={cn(
                  "flex items-center gap-3 rounded-lg px-4 py-2.5 text-[14px] tracking-[-0.02em] transition-all duration-150 border",
                  isActive
